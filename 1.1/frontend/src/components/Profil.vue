                ...
                <div class="modal-content">
                    ...
                    <div class="labelsAlign modal-body">
                        ...
                        <div @keyup="checkBio" class="form-group">
                            ...
                            <button v-if="!BioEdit" type="button" title="Mettre à jour" class="btn btn-primary" disabled>Mettre à jour</button>
                        ...
                        <div v-show="isAdmin" class="form-group">
                            ...
                            <button id="AddRight" @click="addRight" type="button" title="Accorder les drois modérateur" class="btn btn-primary" disabled>Accorder</button>
                            <button id="RemoveRight" @click="removeRight" type="button" title="Supprimer les drois modérateur" class="btn btn-danger" disabled>Retirer</button>
